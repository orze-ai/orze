"""Replicate the same Haiku A/B design after the observed parser regression fix."""
import hashlib
import json
import os
...
pilot.credentials()
output=pilot.ROOT/'real-memory-pilot-20260916-fixed'
output.mkdir(mode=0o700)
budget={'authorized_total_usd':5000,'prior_reserved_upper_bound_usd':181,'new_upper_bound_usd':32,
        'total_reserved_upper_bound_usd':213,
        'arithmetic':'8 projects x 4 processes x 100000-token envelope x $5/M maximum rate = $16; reserve $32',
        'scope':'same 4 paired Haiku tasks after memory parser fix; no post-result resampling',
