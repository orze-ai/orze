...
def main():
    pilot.credentials()
    root = pilot.ROOT / 'real-memory-counterexample-diagnostic-20260916-v6'
    root.mkdir(mode=0o700)
    budget = {'authorized_total_usd': 5000, 'prior_reserved_upper_bound_usd': 257,
              'additional_upper_bound_usd': 2, 'total_reserved_upper_bound_usd': 259,
              'bound': 'Two research cycles share one 200000-token process envelope at $5/M; maximum $1, reserve $2. No fallback. This allows the added memory-write request within the same original two-cycle dollar bound.',
