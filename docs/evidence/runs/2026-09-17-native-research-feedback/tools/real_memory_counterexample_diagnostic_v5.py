...
def main():
    pilot.credentials()
    root = pilot.ROOT / 'real-memory-counterexample-diagnostic-20260916-v5'
    root.mkdir(mode=0o700)
    budget = {'authorized_total_usd': 5000, 'prior_reserved_upper_bound_usd': 255,
              'additional_upper_bound_usd': 2, 'total_reserved_upper_bound_usd': 257,
