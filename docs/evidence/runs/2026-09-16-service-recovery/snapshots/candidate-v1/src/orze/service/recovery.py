...
def _inactive(svc):
    ...
    from orze.service.runtime_contract import _systemd_properties
    ...
    properties = [_systemd_properties(unit, kind='timer') if unit == units[1]
                  else _systemd_properties(unit) for unit in units]
