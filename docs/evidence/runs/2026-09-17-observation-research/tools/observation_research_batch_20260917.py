...
plan=json.loads((ROOT/'observation_research_plan_20260917.json').read_bytes())
root=ROOT/'observation-research-20260917'
root.mkdir(mode=0o700)
(root/'tmp').mkdir()
(root/'plan.json').write_bytes((ROOT/'observation_research_plan_20260917.json').read_bytes())
runner=ROOT/'observation_research_20260917.py'
