...
plan=json.loads((ROOT/'memory_next_step_plan_20260917.json').read_bytes())
root=ROOT/'memory-next-step-pairs-20260917'
root.mkdir(mode=0o700)
(root/'tmp').mkdir()
(root/'plan.json').write_bytes((ROOT/'memory_next_step_plan_20260917.json').read_bytes())
runner=ROOT/'memory_next_step_diagnostic_20260917.py'
