...
out=ROOT/'model-settings-check-20260917-v2'
out.mkdir(mode=0o700)
(out/'tmp').mkdir()
names=['src/orze_pro/agents/research_llm.py','tests/test_anthropic_research_settings.py','tests/test_provider_usage_journal.py']
