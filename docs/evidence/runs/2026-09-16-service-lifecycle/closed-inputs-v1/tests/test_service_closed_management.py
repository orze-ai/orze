...
from orze.service import host, runtime_contract, scoped
...
@pytest.mark.parametrize('mutation', ['active_main', 'active_watchdog', 'active_timer', 'live_pid',
    'remaining_cgroup', 'timer_target', 'ack_missing', 'closed_hash', 'after_first_disable'])
