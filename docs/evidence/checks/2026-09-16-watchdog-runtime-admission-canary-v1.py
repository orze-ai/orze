"""Own disposable child only: invalid runtime must not terminate an unrelated live process."""
...
try:
    ...
    value={'script_sha256':hashlib.sha256(Path(__file__).read_bytes()).hexdigest(),
        ...
        'audit_before':before,'watchdog_error':error,'actual_controllers':0,'actual_managers':0,
