...
ROOTS = {
    "profile": "/tmp/orze-dedup-exact-config-profile-20260915-v1",
    "benchmark_v1": "/tmp/orze-dedup-exact-config-benchmark-20260915-v1",
    "benchmark_v2": "/tmp/orze-dedup-exact-config-benchmark-20260915-v2",
    "product": "/tmp/orze-dedup-exact-config-product-20260915",
}
