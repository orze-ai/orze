...
def products():
    ...
    for name,total,variant in [('product-old-v1',1,'old'),('product-controls-v1',2,'old'),('product-v1',4,'new')]:
        ...
        for row in report['cases']:
            ...
            initial=row['initial_install']['result'];saved=initial['saved']
...
def main():
    ...
    specs=[('baseline',0,(78,0,0,0)),('old-feature',1,(24,18,0,0)),('targeted-v1',0,(102,0,0,0)),
        ...
        ('product-v1',0,None),('archive-v1',1,None),('archive-v2',0,None)]
    ...
    for name in ('probe-v1','product-old-v1','product-controls-v1','product-v1','archive-v1','archive-v2'):
