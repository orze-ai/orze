...
class ProductProcess:
    def __init__(self, root, mode):
        ...
        # This fixture constructs the current layout. Without its version,
        # legacy migration moves the current public trigger elsewhere.
        (self.db.parent / 'state').mkdir()
        (self.db.parent / 'state' / 'version.json').write_text('{"layout": 1}\n')
