...
def run_report_only(args) -> int:
    ...
    try:
        ...
        try:
            ...
            # Config-directory scope also applies when results are nested or
            # live elsewhere: relative custom database paths are not anchored
            # to the results parent or the invoking shell's cwd.
            cfg["_project_root"] = str(config_path.parent)
