...
No-Lake repair uses that exact immutable claim scope in mode=ro and never
creates/migrates a database. Missing legacy bindings retain legacy behavior;
an explicit but unavailable/redirected binding never downgrades to legacy.
"""
