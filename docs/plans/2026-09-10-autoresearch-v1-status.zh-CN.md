...
| V1-05 至 V1-07 | 未验收完成 | B1/B2/B3 关闭声明产物、隔离评估、独立观察、绑定补评与显式复验的本版机制，C1/C1b 关闭内置清理与 GC，C2a/C2b 关闭新原生评估/训练的进程树闭合；继续 posthoc 及其他执行归属、恢复、消费记账和通用 CPU 闭环，不能以局部机制替代整版验收 |
