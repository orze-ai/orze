...
@pytest.mark.parametrize("statement", [
    "DELETE FROM idea_state WHERE idea_id=NEW.task_id;",
    "UPDATE ideas SET status='completed' WHERE idea_id=NEW.task_id;",
    "UPDATE idea_state SET current_state='FAILED' WHERE idea_id=NEW.task_id;",
    "UPDATE idea_state SET sop_type='training' WHERE idea_id=NEW.task_id;",
])
def test_request_trigger_cannot_erase_admission_state_then_ack_inserted(context, statement):
    lake, results, cfg, decision = context
